...
- **Choice'lar foldout ile**: Her choice icinde 10 foldout grubu:
  1. **Modifiers** — supportModifier, suspicionModifier, reputationModifier, politicalInfluenceModifier, costModifier, cornerGrabModifier
  2. **Protest Etkisi** — protestModifier, olasilikli tepki (hasProtestChance + alt alanlari)
  4. **Diger Sonuclar** — endsWar, reducesReward, endsWarWithDeal, blocksEvents
